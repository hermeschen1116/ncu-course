...
# variables
label_val: list = ['<PAD>', 'B-person', 'I-person', 'B-geo-loc', 'I-geo-loc', 'B-company',
				   'I-company',
				   'B-facility', 'I-facility', 'B-product', 'I-product', 'B-musicartist',
				   'I-musicartist',
				   'B-movie', 'I-movie', 'B-sportsteam', 'I-sportsteam', 'B-tvshow', 'I-tvshow',
				   'B-other', 'I-other', 'O']
...
trainer = Trainer(max_epochs=num_epoch, auto_lr_find=True, accelerator='auto', reload_dataloaders_every_n_epochs=1,
